...
L.LayerGroup.include({
	...
	_snakeNext: function() {
		//console.log('inside _snakeNext');

		if (this._snakingLayersDone >= this._snakingLayers.length) {
			console.log("_snakingLayersDone   "+this._snakingLayersDone);
			console.log("_snakingLayers.length	"+this._snakingLayers.length);
			console.log('inside this._snakingLayersDone >= this._snakingLayers.length');
			this.fire('snakeend');
			this._snaking = false;
			return;
		}
